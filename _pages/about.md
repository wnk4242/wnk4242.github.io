...
Conceptual illustration of how biasing mechanisms in original studies influence replication outcomes when the true effect does not exist (θ = 0). The original studies, affected by p-hacking and publication bias, are more likely to report significant findings (true positives) even in the absence of a real effect. In contrast, replication studies are preregistered and unbiased, yielding results that accurately reflect the true null effect (true negatives). The discrepancy between the biased originals and unbiased replications produces a larger proportion of false failures and a smaller proportion of true successes.
