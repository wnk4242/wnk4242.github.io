...
My [doctoral work](https://github.com/wnk4242/wnk4242.github.io/blob/master/_pages/research.md) introduces a new replication success classification framework for multisite direct replication studies (e.g., the ManyLab replication projects) that goes beyond the traditional binary distinction of replication success and failure by distinguishing between true and false replication successes and failures. My work reveals how bias (_p_-hacking and publication bias) and study-level factors (e.g., statistical power) dynamically shape the replication outcomes.
